...
{#if openForm}
    <article class="form-article" transition:fade>
        <form class="contact-form">
            ...
            <button type="submit" class="btn-primary submit">send</button>
            <div on:click={closeForm} class="btn-primary close">close</div>
        </form>
    </article>
{:else}
    <GetInTouch />
